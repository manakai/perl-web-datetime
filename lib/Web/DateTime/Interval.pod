...
=head1 SYNOPSIS
  ...
  $interval = Web::DateTime::Interval->new_from_date_times ($dt1, $dt2);
  warn $interval->to_date_times_string;
...
=item $interval = Web::DateTime::Interval->new_from_date_times ($dt1, $dt2)
...
=item $interval = Web::DateTime::Interval->new_from_date_time_and_duration ($dt, $duration)
...
=item $string = $interval->to_date_times_string
...
=item $string = $interval->to_date_time_and_duration_string
